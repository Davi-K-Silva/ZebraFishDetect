...
class FrameTracker:
    ...
    def frameTracker(self,ret,grayMedianFrame,cap,reset, comparison, tracker,length,vet,countVet,getCountours,mask,color,correct,wrong,filter,FrameImplementation,countFrame,readColors,countCol,colorFishes):
        ...
        verCol = True
        length,vet,countVet,fishes_ids,countCol,reset,comparison,verCol,correct,wrong,frame,colorFishes = readColors.forReadColors(length,vet,countVet,fishes_ids,countCol,reset,comparison, verCol,correct,wrong,frame,colorFishes)
        ...
        return ret,frame,gframe,dframe,th,cnts,hierarchy,mask,detections,color,length,vet,countVet,fishes_ids,countCol,reset, comparison, verCol,correct,wrong,frame,colorFishes,countFrame